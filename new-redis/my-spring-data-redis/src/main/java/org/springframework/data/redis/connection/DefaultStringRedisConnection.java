...
public class DefaultStringRedisConnection implements StringRedisConnection, DecoratedRedisConnection {
	...
	public Cursor<Entry<String, String>> hScan(String key, ScanOptions options) {
		...
		return new ConvertingCursor<Entry<byte[], byte[]>, Entry<String, String>>(
				this.delegate.hScan(this.serialize(key), options),
				new Converter<Entry<byte[], byte[]>, Entry<String, String>>() {
	...
	public Cursor<StringTuple> zScan(String key, ScanOptions options) {
		return new ConvertingCursor<Tuple, StringTuple>(delegate.zScan(this.serialize(key), options),
				new TupleConverter());
	}
