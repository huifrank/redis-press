...
public class LettuceSentinelConnection implements RedisSentinelConnection {
	...
	/**
	 * @param masterName
	 * @see org.springframework.data.redis.connection.RedisSentinelCommands#slaves(NamedNode)
	 * @return
	 */
	...
	/**
	 * @param masterName
	 * @see org.springframework.data.redis.connection.RedisSentinelCommands#remove(NamedNode)
	 */
